  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-[#E0F2F1] to-white rounded-xl p-4 sm:p-5 border border-[#00838F]/10 shadow-sm">
          <div className="flex items-center justify-between mb-2">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {[
          ...
          <a
            key={action.label}
            href={action.href}
            className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 hover:border-[#00838F]/20 hover:shadow-md transition-all group"
          >
